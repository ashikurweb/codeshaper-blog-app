...
<head>
  ...
  <link rel="icon" href="{{ asset('frontend/pictures/favicon.png') }}">
 ...
 <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/toastify-js"></script>
  <title>@yield('title', 'CodeShaper Blogify Web Application With Laravel')</title>
  @stack('styles')
</head>
<body x-data="{ page: 'home', 'loaded': true, 'stickyMenu': false, 'navigationOpen': false, 'scrollTop': false }">
  ...
  <!-- ====== Back To Top End ===== -->
<script defer src="{{ asset('frontend/scripts/scripts.js') }}"></script>
